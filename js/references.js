...
var goalReferences = ['intRecruitment', 'intStakeholder', 'medina2019does', 'filippova2017from', 'intIdeation', 'intDuration', 'intAgenda', 'g48cyber', 'pe2019understanding', 'globalhack', 'nolte2020mentor', 'intMentor', 'astrohackweek', 'woc', 'intContinuity', 'pe2020corporate'];
var themeReferences = ['intGoal', 'intStakeholder', 'globalhack', 'woc', 'g48cyber', 'astrohackweek', 'geohackweek', 'openbio', 'brainhack', 'zapico2013hacking', 'hackhpc', 'oneweek', 'pe2019understanding'];
var competitionReferences = ['intStakeholder', 'intRecruitment', 'intGoal', 'intTheme', 'biohack', 'debcamp', 'pe2019understanding', 'mlhjudging', 'playbook', 'nolte2018you', 'oneweek', 'prizes', 'mlhprizes'];
var stakeholderReferences = ['intTheme', 'intContinuity', 'stakeholderanalysis', 'steelhacks', 'g48cyber', 'nolte2018you', 'chihacknightprojects', 'pe2019understanding', 'mlhsponsors', 'intMentor', 'nolte2020mentor', 'codeforpgh', 'oneweek', 'intGoal'];
var recruitmentReferences = ['intGoal', 'intTheme', 'astrohackweek', 'geohackweek', 'mlhmarketing', 'intStakeholder', 'oneweek', 'pe2019understanding', 'pe2019designing', 'hackweektoolkit', 'wocschedule', 'intIdeation', 'intTeam', 'hackweektoolkitrecruit', 'sheinnovates', 'entrofy'];
var preparationReferences = ['intTheme', 'intGoal', 'intTeam', 'intMentor', 'nolte2020mentor', 'codecademy', 'intRecruitment', 'woc', 'astrohackweek', 'geohackweek', 'hackhpc', 'brainhack'];
...
var ideationReferences = ['filippova2017from', 'intStakeholder', 'intTheme', 'dayofcivichacking', 'greenhackathon', 'nolte2019touched', 'intGoal', 'pe2019understanding', 'intContinuity', 'flow', 'brainstorm', 'intMentor', 'brainstormquestion', 'intTeam', 'intPreparation'];
var teamReferences = ['intRecruitment', 'intIdeation', 'intStakeholder', 'pe2020corporate', 'hackbox', 'pe2019understanding', 'steelhacks', 'intAgenda', 'intCompetition', 'intGoal', 'nolte2020mentor', 'intMentor', 'intTheme'];
