...
var references = [{
	...
	'type': 'pub',
	'text': 'Spikol, D., Zabei, L., Rapur, K., Ohsaki, A., & Nolte, A. (2024). Investigating Hackathons with Collaboration Analytics. In: <i>Proceedings of the 8th International Conference on Game Jams, Hackathons, and Game Creation Events</i>.',
	'title': 'Investigating Hackathons with Collaboration Analytics. <i>International Conference on Game Jams, Hackathons, and Game Creation Events</i>',
	...
	'link': 'Spikol-ICGJ-2024.pdf'
}, {
	'id': 'holmen2024facultyhack',
	'type': 'pub',
	'text': 'Holmen, J. K., Powell, J., Nolte, A., MacCarthy, E., Dey, C., Vergara Larrea, V. G., Parete-Koon, S., & Hayden, L. B. (2024). FacultyHack Events: Faculty-Focused Hackathons for High-Performance Computing Curriculum Development. In: <i>Proceedings of the 8th International Conference on Game Jams, Hackathons, and Game Creation Events</i>.',
	'title': 'FacultyHack Events: Faculty-Focused Hackathons for High-Performance Computing Curriculum Development. <i>International Conference on Game Jams, Hackathons, and Game Creation Events</i>',
	'abstract': 'Broadening participation initiatives are important for engaging underrepresented groups in science, technology, engineering, and math (STEM). Such initiatives help foster supportive and inclusive work environments that promote creativity and productivity. While there are initiatives that aim to engage students and faculty, opportunities remain to improve faculty support. Hackathons have proved to be a useful approach for student engagement. There are, however, limited insights into whether and how such events would also work for faculty aiming to develop curricula. This paper discusses the design of a faculty-focused hackathon event, FacultyHack, for curriculum development. We outline the logistics and structure for two past FacultyHack events, detail changes between events, and describe potential improvements and lessons learned.',
	'link': 'Holmen-ICGJ-2024.pdf'
}, {
	'id': 'maillart2024computational',
	'type': 'pub',
	'text': 'Maillart, T., Gomez, L., Lombard, E., Nolte, A., & Pisano, F. (to appear). Computational Diplomacy: How "hackathons for good" feed a participatory future for multilateralism in the digital age. <i>Philosophical Transactions of the Royal Society A</i>.',
	'title': 'Computational Diplomacy: How "hackathons for good" feed a participatory future for multilateralism in the digital age. <i>Philosophical Transactions of the Royal Society A</i>',
	...
	'link': 'Imam-ICSOFT-2023.pdf'
}, {
	'id': 'paganini2023opportunities',
	'type': 'pub',
	'text': 'Paganini, L., Gama, K., Nolte, A., & Serebrenik, A. (2023). Opportunities and constraints of women-focused online hackathons. <i>IEEE/ACM 4th Workshop on Gender Equity, Diversity, and Inclusion in Software Engineering</i>, 30-40.',
	...
	'type': 'pub',
	'text': 'Powell, J., Hayden, L. B., Cannon, A., Holly, J., Dey, C. & Nolte, A. (2022). The HackHPC Model: Fostering Workforce Development in High-Performance Computing Through Hackathons. Poster presented at <i>Gateways 2022</i>.',
	'title': 'The HackHPC Model: Fostering Workforce Development in High-Performance Computing Through Hackathons. <i>Gateways 2022</i>',
